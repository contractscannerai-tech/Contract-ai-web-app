...
// PORT is only required when running the dev/preview server (e.g. inside
// Replit). For CI builds (`vite build`) it can safely default — the produced
// static bundle does not embed the port.
